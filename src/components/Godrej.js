...
// Import Godrej images
import GodrejImage from "./../images/Godrej/Godrej&Boyce.png"
...
const Godrej = () => {
  ...
  const carouselItems = data.godrejCarouselItems.map(item => ({
    ...item,
    ...
    <div className="section" id="work">
      <div className="container">
        <Fade bottom cascade distance="20px">
          <h1>{getText(data.sections.work, language)}</h1>
          <h3>{getText(data.workSubheading, language)}</h3>
        ...
        <div className="nvidia-section">
          ...
          <div className="content">
            {data.godrejExperience.map((exp, index) => (
